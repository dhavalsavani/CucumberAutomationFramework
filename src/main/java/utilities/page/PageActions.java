...
public class PageActions {
	...
	public static WebElement waitUntilVisisbilityOfElementLocatedBy(By by) {
		return waitUntilVisisbilityOfElementLocatedBy(by, Integer.parseInt(Configuration.getProperty("explicit.wait")));
	}
	...
	public static boolean waitUntilInVisisbilityOfElementLocatedBy(By by) {
		return waitUntilInVisisbilityOfElementLocatedBy(by, Integer.parseInt(Configuration.getProperty("explicit.wait")));
	}
	...
	public static WebElement waitUntilElementLocatedByIsClickable(By by) {
		return waitUntilElementLocatedByIsClickable(by, Integer.parseInt(Configuration.getProperty("explicit.wait")));
	}
